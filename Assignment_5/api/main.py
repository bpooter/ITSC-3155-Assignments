...
"""Start of Order Detail Endpoints"""
...
def get_one_order_detail(order_detail_id: int, db: Session = Depends(get_db)):
...
def get_one_recipe(recipe_id: int, db: Session = Depends(get_db)):
...
@app.put("/resources/{resources_id}", response_model=schemas.Resource, tags=["Resources"])
